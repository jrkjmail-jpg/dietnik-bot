...
BOT_RELEASE=2026.06.13-premium-upgrade-1
...
же даты, до которой был оплачен Basic. В сообщениях, закрывающих Premium-функции,
бот показывает только кнопку Premium; повторно купить Basic там нельзя.
...
Бот должен показать `2026.06.13-premium-upgrade-1`. Если показывает старую версию или
